...
app.get("/native",function(req,res) {
  console.log("Native user logged in ");
  req.session.user = "binary";
  notifyAllAbout(req.session.user);
  res.send(200);
